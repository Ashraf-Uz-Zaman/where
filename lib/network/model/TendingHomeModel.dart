...
class TendingHomeModel {
  ...
  TendingHomeModel({Data? data, int? code, String? message, bool? isSuccess}) {
    _data = data;
    _code = code;
    _message = message;
  ...
  TendingHomeModel.fromJson(dynamic json) {
...
class Venues {
  ...
  Venues.fromJson(dynamic json) {
    ...
    _venueCategory = json["venueCategory"] != null
        ? VenueCategory.fromJson(json["venueCategory"])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_categoryWiseMenuItems != null) {
      map["categoryWiseMenuItems"] =
          _categoryWiseMenuItems?.map((v) => v.toJson()).toList();
    }
    return map;
  }
}
...
class VenueCategory {
  ...
  VenueCategory.fromJson(dynamic json) {
    ...
    _venueCategoryParent = json["venueCategoryParent"] != null
        ? VenueCategoryParent.fromJson(json["venueCategoryParent"])
        : null;
  }
