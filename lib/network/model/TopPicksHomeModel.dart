...
class TopPicksHomeModel {
  ...
  TopPicksHomeModel.fromJson(dynamic json) {
...
class Venues {
  ...
  List<VenueTime>? _venueTimes;
  List<VenueReview>? _venueReviews;
  ...
  List<VenueTime>? get venueTimes => _venueTimes;
  List<VenueReview>? get venueReviews => _venueReviews;
  ...
  Venues({
      ...
      List<VenueTime>? venueTimes,
      List<VenueReview>? venueReviews,
  ...
  Venues.fromJson(dynamic json) {
    ...
    if (json["venueTimes"] != null) {
      ...
      json["venueTimes"].forEach((v) {
        _venueTimes?.add(VenueTime.fromJson(v));
      });
    }
    if (json["venueReviews"] != null) {
      _venueReviews = [];
      json["venueReviews"].forEach((v) {
        _venueReviews?.add(VenueReview.fromJson(v));
      });
    }
...
class VenueTime {
  VenueTime({
    required this.venueTimeId,
    required this.dayName,
    required this.dayNameAr,
    required this.openTime,
    required this.openTimeAr,
    required this.closeTime,
    required this.closeTimeAr,
  ...
  factory VenueTime.fromJson(Map<String, dynamic> json) => VenueTime(
  ...
  Map<String, dynamic> toJson() => {
    "venueTimeId": venueTimeId,
    "dayName": dayName,
    "dayNameAr": dayNameAr,
    "openTime": openTime,
    "openTimeAr": openTimeAr,
    "closeTime": closeTime,
    "closeTimeAr": closeTimeAr,
    "venueId": venueId,
  };
